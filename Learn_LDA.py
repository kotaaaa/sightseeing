...
def main():
    ...
    for num_topic in num_topics:
        ...
        gensim.corpora.MmCorpus.serialize('cop.mm', corpus)
        ...
        # print(df)
        df.to_csv('LDA_words_'+str(num_topic)+'_4.csv')
        cohsum=0
        ...
        data.to_csv('LDA_'+str(num_topic)+'_4.csv',header=None)
        print(data.head())
        print(data.tail())
        print(data.shape)
